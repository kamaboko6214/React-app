...
const Header = () => {
    return (
        <>        
        <div className='text-gray-700 border-b border-gray-200 sticky top-0 z-50 bg-white bg-opacity-50'>
            <div className='container flex mx-auto p-5 flex-col md:flex-row items-center'>
                ...
                <ul className='flex md:ml-auto text-base'>
                    ...
                    <li><AnchorLink href="#contact" offset="50" className='mr-5 hover:text-green-600 duration-300'>Contact</AnchorLink></li>
                </ul>
            </div>
        </div>
            <Main />
